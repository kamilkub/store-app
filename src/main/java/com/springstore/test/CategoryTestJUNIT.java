...
public class CategoryTestJUNIT {
	 ...
	 public void updateCategory() {
		 category = categoryDAO.getSession(1);
	 ...
	 @Test
	 public void updateCategory() {
		 category = categoryDAO.getSession(2);
	 ...
	 public void addProduct() {
		 ...
		 product.setName("Black Jacket");
		 product.setBrand("H&M");
		 product.setDescription("New Mens Collection for 2018 Summer");
		 product.setUnitPrice(150.99);
		 product.setActive(true);
		 product.setCategoryId(2);
		 product.setSupplierdId(1);
		...
		// assertEquals("Something went wrong!!",1,productDAO.getLatestActiveProducts(1).size());
	 }
